...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const isEmoji = !product.image.startsWith("http") &&
    ...
    <Link href={`/product/${product.id}`} className="block h-full">
      <motion.article
        ...
        className="
          ...
          hover:shadow-[0_20px_60px_rgba(29,151,108,0.12)]
        "
      >
        <div
          className="
        ...
        <div className="flex flex-1 flex-col px-3 pb-3 pt-5">
          ...
          >
            {product.description ||
              "Quality agricultural product for better farming."}
          </p>
